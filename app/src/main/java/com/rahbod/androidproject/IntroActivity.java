...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkConnected())
            Toast.makeText(this, "No internet access. Please check it.", Toast.LENGTH_LONG).show();
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isNetworkConnected())
                    Toast.makeText(IntroActivity.this, "No internet access. Please check it.", Toast.LENGTH_LONG).show();
                else {
            ...
            public void onClick(View v) {
                if (!isNetworkConnected())
                    ...
                    try {
                        ...
                        String response = new RestTask("http://rahbod.ir/projects/android/api.php?action=login",
                        ...
                        if(!json.getBoolean("status")){
                            ...
                            JSONObject profile = json.getJSONObject("details");
                            Intent profileIntent = new Intent(IntroActivity.this, HomeActivity.class);
                            profileIntent.putExtra("name", profile.getString("name"));
                            profileIntent.putExtra("mobile", profile.getString("mobile"));
